...
const Footer = () => {
    ...
    return (
        <footer className="relative border-t border-white/10 bg-zinc-950/80 backdrop-blur-md">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.96 }}
                        onClick={scrollToTop}
                        className="group flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/[0.03] text-xs text-zinc-400 hover:text-white hover:border-white/25 transition-all"
                    >
