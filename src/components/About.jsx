                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-base md:text-lg text-zinc-400 leading-relaxed mb-8">
                            <p>
                                ...
                                frontends. I architect platforms from database
                                schema to pixel-perfect UI — owning every layer
                                of the stack.
                            </p>
                            <p>
                                Recently, I shipped{" "}
                                ...
                                for retail businesses across northern Iran.
                                These aren't template sites — they're
                                custom-built systems handling real business
                                logic, real customers, real scale.
                            </p>
                            <p>
                                Beyond code, I compete in{" "}
                                <span className="text-white font-medium">
                                    algorithmic contests
                                </span>{" "}
                                (ICPC Regional, LeetCode Top 6.9%) because
                                strong problem-solving translates directly to
                                better software architecture. I'm also an active{" "}
                                <span className="text-white font-medium">
                                    chess player
                                </span>{" "}
                                (1500+ ELO) — pattern recognition and thinking
                                three moves ahead are habits I bring to every
                                codebase I touch.
                            </p>
                        </div>
